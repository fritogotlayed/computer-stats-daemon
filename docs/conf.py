...
release = importlib_metadata.version("computer-stats-daemon")
...
htmlhelp_basename = "computer_stats_daemondoc"
...
latex_documents = [
    (
        "index",
        "computer_stats_daemon.tex",
        "Computer Stats Daemon Documentation",
        "Frito",
        "manual",
    ),
]
